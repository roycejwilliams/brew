...
export default function AdminPage() {
  ...
  if (isPending) {
    return (
      <section className="min-h-screen bg-[#0c0c0c] text-white flex items-center justify-center">
        <Loading />
      </section>
    );
  }
  ...
  if (user?.role !== "admin") {
    return (
      <section className="min-h-screen bg-[#0c0c0c] text-white flex items-center justify-center px-6">
        <motion.div
  ...
  return (
    <section className="min-h-screen bg-[#0c0c0c] text-white px-4 sm:px-8 lg:px-12 py-10 pb-24">
      {/* Ambient glow */}
      <div
