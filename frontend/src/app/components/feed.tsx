...
function Feed() {
  return (
    <section className="w-full  mt-8 h-full flex justify-center items-center p-8 ">
      {/* Empty State */}
      <div className="absolute mx-auto bg-[radial-gradient(circle_at_center,#98473E,transparent)] blur-3xl rounded-full opacity-85 w-3/5 h-3/5"></div>

      <div className="flex flex-col gap-y-8 h-full justify-center items-center relative">
        {/* Display Cards */}
        ...
        <div className="flex gap-x-4 items-center text-sm">
          <button className="px-4 py-2 bg-black/30 backdrop-blur-3xl border border-white/15 shadow-lg shadow-[#19535F] rounded-full">
