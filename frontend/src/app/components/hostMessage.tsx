...
export default function HostMessage({
  ...
  return (
    ...
    >
      {/* Message body */}
      <p className="text-black/60 dark:text-white/60 text-sm tracking-[-0.1px] leading-relaxed">
        {hostMessage}
      </p>
      ...
      >
        <div className="flex items-center gap-1.5">
          ...
          />
          <span className="text-black/20 dark:text-white/20 text-[10px] tracking-widest uppercase font-medium">
            Host
          </span>
        </div>
