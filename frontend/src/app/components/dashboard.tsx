...
import { faMapPin, faX } from "@fortawesome/free-solid-svg-icons";
import {
  faInstagram,
  faLinkedin,
  faXTwitter,
...
function Dashboard() {
  return (
    <section className="w-full min-h-screen bg-linear-to-b py-8 px-24 from-[#2b2b2b] to-black">
      {/* Profile */}
      <div className="flex justify-between ">
        {/* UserName */}
        <div className="w-full h-1/4  flex gap-x-4">
          <div className="w-40 h-40 border border-white/20 rounded-xl shadow-xl shadow-[#98473E] relative overflow-hidden">
            <Image
              src="/profile_1.png"
              fill
              priority
          ...
          <div className="flex flex-col ">
            ...
            {/* Bio */}
            <div className="mt-12">Tell Us About Yourself</div>
            {/* Circle */}
            <div className="mt-4 flex items-center gap-x-4">
              <span>0 in circle</span>
